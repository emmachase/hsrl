...
void offsets::initialize() {
  ...
  offsets::luaL_checkstack = offsets::get_exported("xluau", "luaL_checkstack");
  offsets::luaL_newmetatable = offsets::get_exported("xluau", "luaL_newmetatable");
  // offsets::luaL_setmetatable = offsets::get_exported("xluau", "luaL_setmetatable");
  ...
  // offsets::luaL_setfuncs = offsets::get_exported("xluau", "luaL_setfuncs");
  ...
  // offsets::lua_pushfstring = offsets::get_exported("xluau", "lua_pushfstring");
  offsets::lua_pushfstringL = offsets::get_exported("xluau", "lua_pushfstringL");
  // offsets::lua_pushcclosure = offsets::get_exported("xluau", "lua_pushcclosure");
  ...
  // offsets::lua_newuserdata = offsets::get_exported("xluau", "lua_newuserdata");
  ...
  // offsets::lua_dump = offsets::get_exported("xluau", "lua_dump");
  offsets::lua_error = offsets::get_exported("xluau", "lua_error");

  offsets::luau_load = offsets::get_exported("xluau", "luau_load");
  ...
  offsets::map_update = offsets::get_offset("GameAssembly", 0x80a2ed0);
}